...
/*****************************************************解模糊最大隶属度，最大值法which 表示对P，I，D中的哪一种进行解模糊******************************************************/
...
{	float outvar = 0;	float kpvar = 0;	float tivar = 0;
    float tdvar = 0;	float e = 0;	float ec = 0;
	float pRes[10][3] = {0};	float iRes[10][3] = {0};	float dRes[10][3] = {0};	int channel = whichChannel - 1;		
	...
	//printf("cu1=%f,cu2=%f\n",param[channel].cur1,param[channel].cur2);		//模糊化	
