...
uint8_t led_cnts=0;
const uint8_t lk_led_BreathArray[] = {
	1,2,3,5,7,10,14,
	19,24,30,37,45,54,65,76,89,103,
	118,134,150,167,183,199,214,227,238,246,
	251,254,253,249,241,232,219,205,190,174,
	157,141,125,109,95,82,70,59,49,40,
	33,26,21,16,12,9,6,4,2,1,
	};
int main(void)
{
    ClkInit24M();
...
static void DeviceDataInit(void)
{
 ...
 // MassageHandler.MassageMode=MassageAcupuncture;
	MassageHandler.MassageMode=Massage3DAcupuncture; //æµ‹è¯•ç”¨
	MassageHandler.ElectrSliceTyp = electsliceExtFour; //æµ‹è¯•ç”¨
   ...
   switch(Motor_Vibr_Control.Motor_Vibr_flag)
   	{
		...
		if(Motor_Vibr_Control.Motor_Vibr_Time<(Motor_Vibr_Time_Defin+50)) ///  50ms
	  	...
	  	break;
	  case Motor_Vibr_ShutDown:  ///   °´¼üÇáÕñ
	  	 if(Motor_Vibr_Control.Motor_Vibr_flag!=Motor_Vibr_Control.Motor_Vibr_flagOld)
	  	  {
	  		 Motor_Vibr_Control.Motor_Vibr_flagOld=Motor_Vibr_Control.Motor_Vibr_flag;
			 Motor_Vibr_Control.Motor_Vibr_Time=0;
